    ...
    <Box sx={{ display: 'grid', gap: 1, minHeight: 0 }}>
          ...
          <Box sx={{ display: 'grid', gap: 0.75 }}>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
              {VIDEO_PRIMARY_CATEGORIES.map(category => {
                ...
                const isPrimary = draft?.primaryCategoryId === category.id
                ...
                return (
                  <Chip
                    ...
                    color={isPrimary ? 'success' : selected ? 'primary' : 'neutral'}
      ...
      <Box sx={{ display: 'grid', gap: 0.5 }}>
        <TagsContainer
          ...
          disabled={!!disabled}
          type={isGeneral ? 'videoGeneralProfessional' : 'analysis'}
          placeholder="בחר תג מקצועי…"
          maxTags={30}
        />
      </Box>
