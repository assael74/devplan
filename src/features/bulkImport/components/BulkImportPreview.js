// src/features/bulkImport/components/BulkImportPreview.js
...
import BulkImportStatusChip from './BulkImportStatusChip.js'
...
export default function BulkImportPreview({ preview }) {
            ...
            <tbody>
              {rows.map(row => {
                ...
                return (
                  <tr key={row.rowIndex}>
                    <td>
                      <BulkImportStatusChip status={row.status} />
                    </td>
