// src/features/reports/management/fixtures/minutesPlan.fixtures.js
...
export const MINUTES_PLAN_FIXTURES = {
  [REPORTS_MANAGEMENT_SCENARIOS.FULL]: createFixture(),
  ...
  [REPORTS_MANAGEMENT_SCENARIOS.MISSING_MINUTES_TARGETS]: createMissingMinutesTargetsFixture(),
  [REPORTS_MANAGEMENT_SCENARIOS.UNDEFINED_SQUAD_ROLES]: createUndefinedSquadRolesFixture(),
  [REPORTS_MANAGEMENT_SCENARIOS.MISSING_VALUES]: createMissingValuesFixture(),
  [REPORTS_MANAGEMENT_SCENARIOS.EMPTY_SQUAD]: createFixture([]),
}
