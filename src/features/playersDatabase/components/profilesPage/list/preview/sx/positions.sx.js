// features/playersDatabase/components/profilesPage/list/preview/sx/positions.sx.js
...
export const positionsSx = {
  ...
  previewPositionGrid: {
    ...
    gridTemplateColumns: {
      xs: '1fr',
      md: 'minmax(0, 36fr) minmax(0, 36fr) minmax(0, 28fr)',
    },
    gap: 0.55,
    alignItems: 'center',
  },
