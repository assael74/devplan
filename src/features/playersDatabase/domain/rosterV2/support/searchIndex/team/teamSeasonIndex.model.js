...
import { adaptTeamScoutEngineRow } from '../../../../index.js'
...
const toSearchIndexIdSegment = value => clean(value).replace(/[^0-9a-zA-Z]+/g, '_')
...
export const buildTeamSeasonIndexId = ({
  ...
  [
    'birthTeamSeason',
    clean(leagueId),
    toSearchIndexIdSegment(buildSeasonKey(seasonKey)),
    clean(teamId || clubId),
