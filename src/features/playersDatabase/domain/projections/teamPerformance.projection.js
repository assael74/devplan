...
export const roundTeamPerformanceRate = value => {
  const roundedValue = roundPerGameRate(value)
  return roundedValue === null || roundedValue === undefined ? 0 : roundedValue
}
...
export const resolveLeagueSeasonStatus = ({ league = {}, season = {} } = {}) => {
  ...
  if (league?.current && isSameSeason(league.current, seasonIdentity)) {
    return normalizeSeasonStatus(league.current.seasonStatus)
  }
