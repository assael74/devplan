...
export const PLAYER_SCOUT_SEARCH_INDEX_FIELDS = Object.freeze([
  ...
  'scoutBaseImmediacyStatus',
  'scoutAutomaticImmediacyStatus',
  'scoutManualImmediacyStatus',
  'scoutHasManualImmediacyDecision',
  'scoutImmediacyBoostScore',
  'scoutImmediacyBoostIds',
  'scoutImmediacyReductionScore',
  'scoutImmediacyReductionIds',
  'scoutImmediacyNetScore',
  'scoutProfilePersistenceSeasons',
  'scoutCombinationPersistenceSeasons',
  'scoutSignalDecaySeasons',
  'scoutSignalDecayLastSeasonKey',
  'scoutProfileCaseStrengthProfileCount',
  'scoutProfileCaseHasCombination',
