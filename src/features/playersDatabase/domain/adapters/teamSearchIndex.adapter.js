...
export const adaptTeamSearchIndexDocument = document => {
  ...
  const performance = normalizeTeamScout({
    offense: { performance: source.attackPerformance, performanceRate: source.attackPerformanceRate, performanceLevel: source.attackPerformanceLevel, rankingRate: source.attackRankingRate, rankingLevel: source.attackRankingLevel, combinedRate: source.attackCombinedRate, combinedLevel: source.attackCombinedLevel, qualityRate: source.attackQualityRate, scoutPriorityRate: source.attackScoutPriorityRate, priorityRate: firstDomainValue(source.attackPriorityRate, source.attackPerformance), priorityLevel: source.attackPriorityLevel, anomalyLevel: source.attackAnomalyLevel, rank: source.tableAttackRank },
    defense: { performance: source.defensePerformance, performanceRate: source.defensePerformanceRate, performanceLevel: source.defensePerformanceLevel, rankingRate: source.defenseRankingRate, rankingLevel: source.defenseRankingLevel, combinedRate: source.defenseCombinedRate, combinedLevel: source.defenseCombinedLevel, qualityRate: source.defenseQualityRate, scoutPriorityRate: source.defenseScoutPriorityRate, priorityRate: firstDomainValue(source.defensePriorityRate, source.defensePerformance), priorityLevel: source.defensePriorityLevel, anomalyLevel: source.defenseAnomalyLevel, rank: source.tableDefenseRank },
