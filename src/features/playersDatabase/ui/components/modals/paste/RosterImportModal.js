...
import WorkTaskStepper from '../workTask/WorkTaskStepper.js'
import TeamSeasonSelect from '../TeamSeasonSelect.js'
import { PLAYER_ROSTER_COLUMNS, PLAYER_ROSTER_PLACEHOLDER } from '../../../pages/teamPage/logic/teamPage.constants.js'
...
import { PlayerUrlIcon } from '../../../pages/teamPage/hooks/teamStatsColumns.presentation.js'
  ...
  return (
    <>
      <RegularModal
        ...
        disabled={disabled}
        footerActions={activeStep === 2 ? (
          <Button
            size='sm'
            variant='outlined'
            disabled={controller.busy || !controller.rows.length}
            onClick={controller.inspectPayload}
          >
            בדיקת Payload
          </Button>
        ) : null}
