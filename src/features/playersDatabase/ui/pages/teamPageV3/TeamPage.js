            ...
            <Box sx={sx.viewTabsToolbar}>
              <Box sx={sx.viewTabs}>
                <Button
                  ...
                  startDecorator={iconUi({ id: 'team', size: 'sm' })}
                >
                  ניתוח קבוצה
                </Button>
                <Button
                  ...
                  startDecorator={iconUi({ id: 'analyst', size: 'sm' })}
                >
                  ניתוח שחקנים
                </Button>
              </Box>
              <Box sx={sx.seasonPath}>
                {[...(teamInformationView.seasonTimeline || [])].reverse().map((season, index) => (
                  <React.Fragment key={season.seasonKey}>
                    {index > 0 ? <Box sx={sx.seasonPathArrow}>{iconUi({ id: 'back', size: 'sm' })}</Box> : null}
                    <Typography sx={season.seasonKey === selectedSeasonKey ? sx.seasonPathCurrent : sx.seasonPathPrevious}>
                      {season.seasonKey}
                    </Typography>
                  </React.Fragment>
                ))}
