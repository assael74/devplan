...
export const buildTeamSeasonSearchMetrics = ({
  ...
  return {
    ...
    searchGoalsAgainst: roundSearchValue(projectedGoalsAgainstRaw),
    ...
    searchTeamGamePlayed: roundSearchValue(projectedTeamGamePlayedRaw),
  }
}
