...
import { normalizeScoutProfilesSummary } from '../../../../domain/projections/teamScoutSummary.projection.js'
...
export const buildTeamSeasonRosterMetaSyncPlan = ({
  ...
  teamPerformance = null, teamSeasonDocumentId = '', resetStatsDerived = false,
} = {}) => {
