// src/features/liveTagging/LiveTaggingDesktopContainer.js
...
import { LiveEventsList } from './ui/events/index.js'
...
export function LiveTaggingDesktopContainer({ model }) {
  ...
  return (
    <Sheet sx={sx.desktop.root}>
      <Box sx={sx.desktop.content}>
        {model.error && (
          <Box sx={sx.desktop.messageBox('danger')}>
        ...
        {model.saveBlockedMessage && (
          <Box sx={sx.desktop.messageBox('warning')}>
        ...
        {model.saveSuccessText && (
          <Box sx={sx.desktop.messageBox('success')}>
      ...
      <Box sx={sx.desktop.footer}>
        <Box sx={sx.desktop.footerSide('start')}>
          {showLoadDraft && (
            <Button
              size="sm"
              variant="soft"
        ...
        <Box sx={sx.desktop.footerSide('end')}>
          <Button
            size="sm"
            variant="soft"
            color="neutral"
          ...
          <Button
            ...
            sx={sx.desktop.footerMainButton}
          >
