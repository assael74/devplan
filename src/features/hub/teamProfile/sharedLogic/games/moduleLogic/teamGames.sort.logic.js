// teamProfile/sharedLogic/games/moduleLogic/teamGames.sort.logic.js

export const TEAM_GAMES_SORT_OPTIONS = [
...
export function getTeamGamesSortLabel(sortBy) {
...
export function getTeamGamesSortDirectionIcon(sortDirection) {
...
export function sortTeamGamesRows(rows = [], sort = {}) {
