// src/features/hub/teamProfile/sharedLogic/profileData/lightScoring.model.js
...
export const buildTeamLightScoring = ({ team, games, calculationMode = 'games', coachAssessments = {} } = {}) => {
  ...
  return {
    ...
    meta: {
      ...
      source: 'teamProfile.lightScoring',
