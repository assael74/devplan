// teamProfile/mobile/modules/games/components/entryDrawer/EntryEditHeaderDrawer.js
      ...
      <Box sx={sx.titleWrap}>
        <Box sx={sx.titleMain}>
          ...
          <Box sx={sx.titleTextWrap}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
              ...
              <Typography
                level="body-sm"
                sx={{ ...sx.formSubNameSx, borderRadius: 'sm', ml: 0.5 }}
        ...
        <Box sx={sx.titleActions}>
          <Chip
            ...
            variant="soft"
            startDecorator={iconUi({ id: draft?.isPlayed ? 'done' : 'calendar' })}
          >
