// teamProfile/desktop/modules/videos/components/toolbar/TeamVideosBottomBar.js

import React from 'react'
import { Box, Chip } from '@mui/joy'

import TeamVideosSortMenu from './TeamVideosSortMenu.js'
...
export default function TeamVideosBottomBar({
  summary,
  indicators = [],
  totalVideos = 0,
  filteredVideos = 0,
