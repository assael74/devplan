// clubProfile/desktop/modules/players/components/ClubPlayersToolbar.js
...
import { clubPlayersToolbarSx as sx } from '../sx/clubPlayers.toolbar.sx.js'
      ...
      <Box sx={sx.toolbarTop}>
        ...
        <Box sx={sx.filtersInline}>
          ...
          <Chip
            ...
            startDecorator={iconUi({
              id: 'keyPlayer',
              sx: { color: !filters?.onlyKey ? '#f52516' : '' },
            })}
          >
