// features/hub/clubProfile/mobile/ProfileSectionMobile.js
...
function getSectionSubtitle(mode) {
  ...
  if (mode === 'teams') return 'פירוט קבוצות'
  if (mode === 'players') return 'סגלים ושחקנים'
  return 'חזרה לפרופיל מועדון'
}
