// playerProfile/sharedLogic/videos/insightsDrawer/videosInsightsDrawer.logic.js
...
export const createInitialPlayerVideosFilters = () => ({
  search: '',
  periodKey: '',
  scope: 'all',
  categoryKey: '',
...
export function resolvePlayerVideosFiltersDomain(entity, filters = {}, deps = {}) {
  const player = entity || {}
  const videosRaw = asArr(player?.videos)
