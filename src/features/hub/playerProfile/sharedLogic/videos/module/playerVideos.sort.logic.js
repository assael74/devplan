// playerProfile/sharedLogic/videos/moduleLogic/playerVideos.sort.logic.js

export const PLAYER_VIDEOS_SORT_OPTIONS = [
...
export function getPlayerVideosSortLabel(sortBy) {
...
export function getPlayerVideosSortDirectionIcon(sortDirection) {
...
export function sortPlayerVideosRows(rows = [], sort = {}) {
