// src/features/hub/sharedProfile/logic/videos/videoFilters.shared.js
...
export const createInitialVideosFilters = () => ({
  search: '',
  periodKey: '',
  scope: 'all',
  categoryKey: '',
...
export function resolveVideosFiltersDomain(entity, filters = {}, deps = {}) {
  const profileEntity = entity || {}
  const videosRaw = asArr(profileEntity?.videos)
