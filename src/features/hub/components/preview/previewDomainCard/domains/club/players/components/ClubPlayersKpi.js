// preview/previewDomainCard/domains/club/players/components/ClubPlayersKpi.js
...
import { heroSx as sx } from '../sx/clubPlayersKpi.sx'
...
export default function ClubPlayersKpi({ entity, summary }) {
