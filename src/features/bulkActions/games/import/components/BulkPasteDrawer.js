// src/features/bulkActions/games/import/components/BulkPasteDrawer.js
...
import BulkActionsPreview from './BulkActionsPreview.js'
import {
    ...
    >
      <Sheet sx={sx.drawerSheet}>
        ...
        <Box sx={sx.drawerBody}>
          ...
          <BulkActionsPreview preview={preview} />
        </Box>
