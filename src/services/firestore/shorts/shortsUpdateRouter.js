...
export const shortsUpdateRouterMap = {
  ...
  privates: {
    ...
    clubName: { shortKey: 'privates.privatePlayersInfo', path: 'clubName', mode: 'merge' },
    teamName: { shortKey: 'privates.privatePlayersInfo', path: 'teamName', mode: 'merge' },
  ...
  externalGames: {
    ...
    gameLeagueNum: { shortKey: 'externalGames.gameInfo', path: 'gameLeagueNum', mode: 'merge' },
  ...
  videoAnalysis: {
    ...
    ym: { shortKey: 'videoAnalysis.analysisInfo', path: 'ym', mode: 'merge' },
