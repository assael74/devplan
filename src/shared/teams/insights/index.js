...
/*
|--------------------------------------------------------------------------
| Team Players Insights Engine / Public API
|--------------------------------------------------------------------------
|
| אחריות:
| מנוע תובנות על מבנה וביצועי שחקני הקבוצה.
|
| המנוע הזה לא מחשב ציון משחק קבוצה.
| הוא מקבל תוצרי player scoring / player insights,
