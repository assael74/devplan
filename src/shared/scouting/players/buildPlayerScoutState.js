...
} from './dbPlayerScout.adapter.js'
import { normalizePlayerStats } from './playerStats.normalization.js'
...
import { buildPreviousProfileDistancesFromMeasurement } from './playerScoutMeasurement.distances.js'
...
export const resolveImmediacyContext = ({ player, team, season, immediacyContext }) => {
...
export const resolvePlayerSeasonStints = player => {
...
export const buildPlayerScoutState = ({
  ...
  return {
    ...
    scoutPlayerInterest: scoutResult?.playerInterest || null,
