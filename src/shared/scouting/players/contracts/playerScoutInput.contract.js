...
import { PLAYERS_DATABASE_CLUBS_CATALOG } from './playersDatabaseClubs.catalog.js'
import { resolvePlayersDatabaseLeagueGameTime } from './playersDatabaseLeagueGameTime.js'
import {
  cleanDomainValue,
  firstDomainValue,
  toDomainNumber,
