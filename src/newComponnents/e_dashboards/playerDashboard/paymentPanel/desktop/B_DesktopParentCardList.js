...
import DesktopParentFormModal from './BB_DesktopParentFormModal';
...
export default function DesktopParentCardList({ parents = [], setParents, player, actions }) {
