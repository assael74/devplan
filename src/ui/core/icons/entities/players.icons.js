...
export const playerIcons = {
  ...
  gameChanger: <ElectricBolt />,
  promotedTalent: <TrendingUp />,
  lineupBanker: <Verified />,
  lastStation: <Shield />,
  backThreat: <GpsFixed />,
  proAnchor: <Anchor />,
  singleEngine: <Settings />,
  clearScorer: <SportsSoccer />,
  killerEfficiency: <TrackChanges />,
  preliminaryLowOutput: <HelpOutline />,
  attackingSupport: <SupportAgent />,
