/// ui/fields/meetings/MeetingTypeSelectField.js

import * as React from 'react'
import { Box, FormControl, FormHelperText, FormLabel, Option, Select, Typography } from '@mui/joy'
  ...
  return (
    ...
    >
      ...
      <Select
        ...
        renderValue={() => renderTypeValue(value, placeholder)}
        slotProps={{
          listbox: {
