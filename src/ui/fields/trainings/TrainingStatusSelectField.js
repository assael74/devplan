// ui/fields/trainings/TrainingStatusSelectField.js

import * as React from 'react'
import { FormControl, FormHelperText, FormLabel, Select, Option, Stack } from '@mui/joy'
...
export default function TrainingStatusSelectField({
  value,
  onChange,
  error = false,
  disabled = false,
