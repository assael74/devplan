/// ui/fields/selectUi/games/GameSelectField.js
...
import { gameSx, gameSlot } from '../select.sx.js'
import { iconUi } from '../../../core/icons/iconUi.js';
import { getFullDateIl } from '../../../../shared/format/dateUtiles.js';
import { GAME_TYPE } from '../../../../shared/games/games.constants.js';
import { statusStats } from '../../../../shared/stats/stats.status.js'
...
export default function GameSelectField({
  ...
  const typeLabel = (type) => GAME_TYPE.find((i) => i.id === type);
  ...
  return (
    <Stack gap={0.75} sx={{ width: '100%' }} direction="column" dir="rtl">
     {filterable && (
       <Box {...gameSx.boxWraper}>
         {/* Played */}
         <FormControl>
           <Select size="sm" slotProps={gameSx.button} value={played} onChange={(_, v) => patchFilters({ played: v })}>
         ...
         {/* Team */}
         <FormControl>
           <Select size="sm" slotProps={gameSx.button} value={teamId} onChange={(_, v) => patchFilters({ teamId: v ?? '' })}>
         ...
         {/* stats */}
         <FormControl>
           <Select size="sm" slotProps={gameSx.button} value={stats} onChange={(_, v) => patchFilters({ stats: v })}>
         ...
         {/* type */}
         <FormControl>
           <Select size="sm" slotProps={gameSx.button} value={typeId} onChange={(_, v) => patchFilters({ typeId: v ?? '' })}>
