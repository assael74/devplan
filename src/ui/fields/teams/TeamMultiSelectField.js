// ui/fields/teams/TeamMultiSelectField.js
import * as React from 'react'
import { FormControl, FormHelperText, FormLabel, Select, Option, Stack, Chip, Box, Avatar, Typography } from '@mui/joy'
  ...
  return (
    ...
    >
      ...
      <Select
        ...
        onChange={(_, val) => onChange && onChange(uniqIds(val))}
