// src/dev/reports/fixtures/seasonPlan.fixtures.js
...
export const SEASON_PLAN_FIXTURES = {
  ...
  [REPORTS_DEV_SCENARIOS.UNBALANCED_LAYERS]: createUnbalancedLayersFixture(),
  [REPORTS_DEV_SCENARIOS.MISSING_STATUSES]: createMissingStatusesFixture(),
  [REPORTS_DEV_SCENARIOS.MISSING_VALUES]: createMissingValuesFixture(),
  [REPORTS_DEV_SCENARIOS.EMPTY_SQUAD]: createEmptySquadFixture(),
}
